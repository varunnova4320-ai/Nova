...
module.exports.CreateWebServer = function (parent, db, args, certificates, doneFunc) {
    ...
    */
    ...
    function handleManifestRequest(req, res){
        ...
        var manifest = {
            "name": (domain.title != null) ? domain.title : 'Nexvora System',
            "short_name": (domain.title != null) ? domain.title : 'Nexvora System',
    ...
    function handle2faHoldWebSocket(ws, req) {
        ...
        try {
            ...
            var payload = { notification: { title: (domain.title ? domain.title : 'Nexvora System'), body: "Authentication - " + code }, data: { url: '2fa://auth?code=' + cookie.c + '&c=' + deviceCookie } };
    ...
    */
    ...
    function getRenderArgs(xargs, req, domain, page) {
        ...
        xargs.title = (domain.title != null) ? domain.title : 'Nexvora System';
        if (
